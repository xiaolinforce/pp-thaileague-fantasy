...
const translations: Record<string, string> = {
  ...
  "สมัครสมาชิกด้วย EMAIL": "Sign up with EMAIL",
  "การสมัครสมาชิกด้วย Google ยังไม่เปิดใช้งาน":
    "Google sign-up is not available",
  การสมัครสมาชิกด้วยอีเมลยังไม่เปิดใช้งาน: "Email sign-up is not available",
  ย้อนกลับ: "Back",
  หรือ: "or",
  ...
  คะแนนรวมของคุณ: "Your total points",
  "100 อันดับแรก": "Top 100",
  รออัปเดตอันดับ: "Ranking pending",
  ยังไม่มีอันดับที่อัปเดต: "No updated rankings yet",
...
export function translateLegacyEnglish(text: string) {
