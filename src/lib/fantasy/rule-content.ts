    ...
    return [
      {
        ...
        points: [
          ...
          "Auto-fill keeps existing picks and their current starter or substitute roles, fills only vacant slots, targets 3 Level 1, 3 Level 2, and 6 Level 3 players, prefers likely first-choice goalkeepers, and then fills as many foreign-player slots as possible.",
          ...
          "Only after those priorities tie, auto-fill groups players of the same position and Level by published projected points, uses overall rank to break equal projections, prefers the best feasible quality band, and then randomizes within it. The top band contains at least three players or the best 25% of the group.",
          "When captaincy is missing, auto-fill preserves any existing role and fills only the missing role from the best remaining tier, preferring forwards, midfielders, defenders, then goalkeepers. If tier and position tie, it uses the same quality bands before randomizing.",
      ...
      },
      {
        ...
        points: [
          ...
          "A team's first playing Gameweek has unlimited transfers until its deadline, including revisions after the first complete squad is saved.",
          "If earlier Gameweeks carried an incomplete draft, the unlimited opening allowance continues into the first Gameweek in which the team plays.",
          "The deadline is 90 minutes before the first kickoff. Reverting before then restores the full start-of-Gameweek squad, lineup, captaincy, chip, and transfer allowance. In a team's first playing Gameweek, reverting clears all 15 player slots.",
      ...
      },
      {
        ...
        points: [
          ...
          "Any confirmed appearance counts as at least one Fantasy minute, including stoppage-time substitutes: 1 point below 60 minutes and 2 points from 60 minutes. During provisional scoring, a missing result stays pending; a recorded zero-minute result confirms a non-appearance for auto-subs or vice-captain fallback.",
  ...
  return [
    {
      ...
      points: [
        ...
        "จัดตัวอัตโนมัติจะเก็บนักเตะที่เลือกไว้พร้อมบทบาทตัวจริงหรือตัวสำรองเดิม เติมเฉพาะช่องว่าง พยายามเลือกผู้เล่นระดับ 1 จำนวน 3 คน ระดับ 2 จำนวน 3 คน และระดับ 3 จำนวน 6 คน ให้ความสำคัญกับผู้รักษาประตูที่น่าจะเป็นตัวจริงของสโมสร แล้วเติมโควต้าต่างชาติให้มากที่สุด",
        ...
        "เมื่อเงื่อนไขเหล่านั้นเสมอกันเท่านั้น จัดตัวอัตโนมัติจะแบ่งผู้เล่นตำแหน่งและระดับเดียวกันเป็นกลุ่มคุณภาพจากคะแนนคาดการณ์ที่เผยแพร่ ใช้อันดับรวมตัดสินเมื่อคะแนนเท่ากัน เลือกกลุ่มดีที่สุดที่ยังจัดทีมได้ แล้วจึงสุ่มภายในกลุ่มนั้น โดยกลุ่มแรกมีอย่างน้อย 3 คนหรือ 25% แรกของกลุ่ม",
        "เมื่อกัปตันหรือรองกัปตันยังว่าง จัดตัวอัตโนมัติจะเก็บบทบาทที่ตั้งไว้และเติมเฉพาะบทบาทที่ขาดจากผู้เล่นระดับดีที่สุดที่ยังเลือกได้ โดยเรียงกองหน้า กองกลาง กองหลัง และผู้รักษาประตู หากระดับและตำแหน่งเท่ากันจะใช้กลุ่มคุณภาพเดียวกันก่อนสุ่ม",
    ...
    },
    {
      ...
      points: [
        ...
        "Gameweek แรกที่ทีมเริ่มเล่นเปลี่ยนนักเตะได้ไม่จำกัดจนถึง Deadline รวมถึงการแก้ไขหลังบันทึกทีมครบครั้งแรกแล้ว",
        "หาก Gameweek ก่อนหน้ามี Draft ที่ยังไม่ครบ สิทธิ์เปลี่ยนไม่จำกัดจะต่อเนื่องไปถึง Gameweek แรกที่ทีมเริ่มเล่น",
        "Deadline ปิดก่อนคู่แรก 90 นาที การยกเลิกก่อนเวลานั้นจะคืนรายชื่อนักเตะ การจัดตัว กัปตัน Chip และโควต้า Transfer เป็นสภาพต้น Gameweek ส่วน Gameweek แรกที่ทีมเริ่มเล่นจะล้างนักเตะทั้ง 15 ช่อง",
    ...
    },
    {
      ...
      points: [
        ...
        "ผู้ที่ลงสนามนับอย่างน้อย 1 นาทีใน Fantasy รวมถึงตัวสำรองช่วงทดเวลา: เล่นไม่ถึง 60 นาทีได้ 1 คะแนน ตั้งแต่ 60 นาทีได้ 2 คะแนน ระหว่างคิดคะแนน provisional หากยังไม่มีผลบันทึกจะยังไม่ถือว่าไม่ได้ลงสนาม ต้องมีผลบันทึก 0 นาทีจึงใช้ Auto-sub หรือโอนตัวคูณให้รองกัปตัน",
