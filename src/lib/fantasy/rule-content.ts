    ...
    return [
      {
        ...
        points: [
          ...
          "Auto-fill keeps existing picks, targets three players in each of Levels 1–3, prefers likely first-choice goalkeepers, and then fills as many foreign-player slots as possible. It does not use projected points or overall rank.",
  ...
  return [
    {
      ...
      points: [
        ...
        "จัดตัวอัตโนมัติจะเก็บนักเตะที่เลือกไว้ พยายามเลือกผู้เล่นระดับ 1–3 ระดับละ 3 คน ให้ความสำคัญกับผู้รักษาประตูที่น่าจะเป็นตัวจริงของสโมสร แล้วเติมโควต้าต่างชาติให้มากที่สุด โดยไม่ใช้คะแนนคาดการณ์หรืออันดับรวม",
