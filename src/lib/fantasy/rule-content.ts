    ...
    return [
      {
        ...
        points: [
          ...
          "Auto-fill keeps existing picks and their current starter or substitute roles, fills only vacant slots, targets three players in each of Levels 1–3, prefers likely first-choice goalkeepers, and then fills as many foreign-player slots as possible.",
  ...
  return [
    {
      ...
      points: [
        ...
        "จัดตัวอัตโนมัติจะเก็บนักเตะที่เลือกไว้พร้อมบทบาทตัวจริงหรือตัวสำรองเดิม เติมเฉพาะช่องว่าง พยายามเลือกผู้เล่นระดับ 1–3 ระดับละ 3 คน ให้ความสำคัญกับผู้รักษาประตูที่น่าจะเป็นตัวจริงของสโมสร แล้วเติมโควต้าต่างชาติให้มากที่สุด",
