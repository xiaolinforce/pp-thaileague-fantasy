...
function getPreservedCaptaincyIds(members: DraftLineupMember[]) {
...
function assignCaptaincy(
  ...
  let { captainId, viceCaptainId } = getPreservedCaptaincyIds(members);
