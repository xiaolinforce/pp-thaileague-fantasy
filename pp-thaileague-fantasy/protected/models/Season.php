...
class Season extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('start_date, end_date, description, modified_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, start_date, end_date, description, status, deleted, created_date, created_by, modified_date, modified_by', 'safe', 'on'=>'search'),
		);
	}
