...
class Tournament extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name_th, name_en, created_date', 'required'),
			...
			array('id, name_th, name_en, image, description, status, deleted, created_date, created_by, modified_date, modified_by', 'safe', 'on'=>'search'),
		);
	}
