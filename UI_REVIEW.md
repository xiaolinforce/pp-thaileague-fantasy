...
| `/admin/fantasy` and children | Operational tool      | In progress | Eight-page workspace; the read-only reminder-audience/preview route is implemented but awaits authenticated rendered evidence, while live mutations and missing-data states remain excluded. |
